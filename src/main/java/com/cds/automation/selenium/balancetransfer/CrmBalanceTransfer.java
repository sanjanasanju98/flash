...
*/
@Component
public class CrmBalanceTransfer implements CrmGuiFactory {
  ...
  @Autowired
  private BalanceTransferProcessor processor;
  ...
  public TestResults executeRequest(
    ...
    for (final Map<String,String> data : dataSet) {
      try {  
        ...
        processor.dealerBalanceTransfer(doc, data);
